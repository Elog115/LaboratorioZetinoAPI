...
namespace SisLabZetino.Domain.Entities
{
    ...
    public class Usuario
    {
        ...
        // **A considerar:** Revisa si la longitud (8) es suficiente para tu país.
        [Required]
        [Column("telefono")]
        [StringLength(8)]
        ...
        // 🟢 CORRECCIÓN CLAVE: Se elimina [Required] y se hace nullable (DateTime?)
        // para prevenir el error de la base de datos cuando no se envía una fecha válida.
